...
func TestJsoninJsonParser(t *testing.T) {
	input := "{\"my_json\": \"{\\\"activity\\\": \\\"my_activity\\\", \\\"process_instance_id\\\": \\\"my_instance\\\", \\\"@timestamp\\\": \\\"2021-11-22T12:13:14.000\\\", \\\"inner_attribute\\\": \\\"foo\\\"}\", \"outer_attribute\": \"bar\"}"
	...
	evt, err := parser.Parse([]byte(input))
	...
	input2 := "{\"activity\": \"my_activity\", \"process_instance_id\": \"my_instance\", \"@timestamp\": \"2021-11-22T12:13:14.000\", \"inner_attribute\": \"foo\"}"
	parser2 := NewJsonParser(JsonParserConfig{
		ActivityPath:          "activity",
		ProcessInstanceIdPath: "process_instance_id",
		TimestampPath:         "@timestamp",
		TimestampFormat:       "2006-01-02T15:04:05.000",
	...
	evt2, err := parser2.Parse([]byte(input2))
	require.NoError(t, err)
